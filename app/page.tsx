        ...
        <main id="main-content" className="max-w-2xl mx-auto px-6 py-10 space-y-10">
          ...
          <section>
            ...
            <div className="mt-4 flex gap-3 flex-wrap">
              <a href="/privacidade" className="text-sm px-3 py-1.5 rounded-lg bg-green-500/20 text-green-500 hover:bg-green-500/30 transition-colors">
                Política de Privacidade
              </a>
              <span className="text-sm px-3 py-1.5 rounded-lg bg-blue-500/20 text-blue-500">
                Conforme LGPD
              </span>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-sm opacity-70 mb-4">
              Todos os dados são obtidos de fontes governamentais oficiais e são de domínio público.
              Links levam diretamente às fontes originais para verificação.
            </p>
              ...
              {[
                {
                  ...
                  data: 'Presença em sessões, proposições, despesas de gabinete, fotos, emails'
                },
                {
                  name: 'Tribunal Superior Eleitoral (TSE)',
                  url: 'https://divulgacontas.tse.jus.br',
                  data: 'Patrimônio declarado, financiamento de campanha, gênero, raça, situação cadastral'
                },
                {
                  name: 'Portal da Transparência (Transferegov)',
                  url: 'https://portaldatransparencia.gov.br',
                  data: 'Emendas Pix (transferências especiais), cota parlamentar'
                },
                {
                  name: 'STF - Intenção de Voto',
                  url: 'https://www.tse.jus.br',
                  data: 'Resultados eleitorais por UF'
                }
              ].map((source, i) => (
                <div key={i} className={`p-4 rounded-xl ${isDark ? 'bg-white/5' : 'bg-black/5'}`}>
                  ...
                  <p className="text-sm opacity-70">{source.data}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          {/* Privacy */}
          <section>
            <h2 className="text-xl font-bold mb-4 font-mono">Privacidade</h2>
            <div className={`p-5 rounded-xl ${isDark ? 'bg-white/5' : 'bg-black/5'}`}>
              <div className="flex items-center gap-2 mb-3">
                <div className="w-3 h-3 rounded-full bg-green-500" />
                <span className="font-semibold">Sem rastreamento</span>
              </div>
              <ul className="text-sm opacity-80 space-y-2">
                <li>• Não utilizamos cookies de rastreamento ou análise</li>
                <li>• Não transmitimos seus dados para terceiros</li>
                <li>• Dados salvos ficam apenas no seu navegador (localStorage)</li>
                <li>• Você pode excluir seus dados a qualquer momento</li>
              </ul>
              <div className="mt-4 pt-4 border-t border-white/10">
                <p className="text-sm opacity-70">
                  Conforme à <strong>LGPD (Lei 13.709/2018)</strong>. Suas preferências são armazenadas 
                  apenas localmente e nunca são compartilhadas.
                </p>
              </div>
            </div>
          </section>
          ...
          {/* Data Categories */}
          <section>
            <h2 className="text-xl font-bold mb-4 font-mono">Categorias de Dados</h2>
            <div className="grid grid-cols-2 gap-3">
              {[
                { label: 'Dados Reais', desc: 'Patrimônio, financiamento, presença, emendas, gênero, raça', color: 'green' },
                { label: 'Dados Públicos', desc: 'Nome, partido, estado, foto, cargo', color: 'blue' },
                { label: 'Dados Calculados', desc: 'Bancada, tema principal, alinhamento', color: 'yellow' },
                { label: 'Estimativas', desc: 'Projetos arquivados, processos genéricos', color: 'orange' }
              ].map((cat, i) => (
                <div key={i} className={`p-4 rounded-xl ${isDark ? 'bg-white/5' : 'bg-black/5'}`}>
                  <div className={`w-2 h-2 rounded-full bg-${cat.color}-500 mb-2`} />
          ...
          {/* Open Source */}
          <section>
            <h2 className="text-xl font-bold mb-4 font-mono">Código Aberto</h2>
            <p className="text-sm opacity-70 mb-4">
              Este projeto é open source e pode ser auditado, forkado e contribuir.
            </p>
            <div className={`p-4 rounded-xl ${isDark ? 'bg-white/5' : 'bg-black/5'}`}>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold">LEGI_VIZ</p>
                  <p className="text-xs opacity-60">github.com/anomalyco/legi_viz</p>
                </div>
              </div>
            </div>
          </section>
          ...
          {/* Legal */}
          <section className={`p-5 rounded-xl ${isDark ? 'bg-white/5' : 'bg-black/5'}`}>
            <h2 className="text-base font-bold mb-3 font-mono">Aviso Legal</h2>
            <div className="text-sm opacity-70 space-y-3">
              <p>
                Informações compiladas de fontes públicas oficiais. Podem conter atrasos em relação às fontes originais.
                Sempre verifique dados críticos diretamente nas fontes governamentais.
              </p>
              <p>
                Esta plataforma não emite julgamentos de valor sobre parlamentares. A presunção de inocência 
                é garantida pela Constituição Federal de 1988, Art. 5º, LVII.
              </p>
              <p className="text-xs opacity-50">
                Dados eleitorais são de domínio público conforme Lei de Acesso à Informação (Lei 12.527/2011).
              </p>
            </div>
          </section>
        </main>
